...
from utils.pickler import sample_weights
...
fs_methods_lr = [
    ...
    # 4. EMBEDDED METHOD: Lasso (L1) Regularization directly on the model
    {
        ...
        "feature_selector": {},
         ...
         # The model itself performs the feature selection via L1 penalty
        "param_grid": {
            "C": [0.01, 1.0], # Tuning regularization strength is key here
            "penalty": ['l1'],
...
fs_methods_xgb = [
    # 8. WRAPPER: Sequential Forward Selection (SFS)
    {
        ...
        "feature_selector": {
            "selector": SequentialFeatureSelector,
            "param_grid": {
                # 🚀 FIX: Using non-linear Random Forest to guide the search
